...
<?php include('includes/header.php')?>
   ...
   <section class="slider__area p-relative">
            <div class="slider__wrapper swiper-container">
               <div class="swiper-wrapper">
                 <div class="single-slider swiper-slide slider__height slider__overlay d-flex align-items-center" data-background="<?php echo base_url()?>assets/img/slider/slider-4.jpg">
                     <div class="container">
                        <div class="row">
                           <div class="col-xxl-7 col-xl-8 col-lg-9 col-md-9 col-sm-10">
                              <div class="slider__content">
                                 <span>NIELIT Courses</span>
                                 <h3 class="slider__title">NIELIT<span class="yellow-bg"><img src="<?php echo base_url()?>assets/img/shape/yellow-bg.png" alt=""> </span></h3>
                                 <p>NIELIT is an autonomous society that works under the Govt.of India to carry out Human resource</p>
                                 <a href="<?php echo base_url()?>Home/about" class="e-btn slider__btn">Ready to get Started?</a>
                              </div>
                           </div>
                        </div>
                     </div>
                  </div>
                 <div class="single-slider swiper-slide slider__height slider__overlay d-flex align-items-center" data-background="<?php echo base_url()?>assets/img/slider/slider-1.jpg">
                     <div class="container">
                        <div class="row">
                           <div class="col-xxl-7 col-xl-8 col-lg-9 col-md-9 col-sm-10">
                              <div class="slider__content">
                                 <span>Vocational Courses</span>
                                 <h3 class="slider__title">Vocational Courses<span class="yellow-bg"><img src="<?php echo base_url()?>assets/img/shape/yellow-bg.png" alt=""> </span></h3>
                                 <p>We are running Self Certified Courses for 12 Months (Diploma in Advance Computer Software)</p>
                                 <a href="<?php echo base_url()?>Home/about" class="e-btn slider__btn">Ready to get Started?</a>
                              </div>
                           </div>
                        </div>
                 ...
                 <div class="single-slider swiper-slide slider__height slider__overlay d-flex align-items-center" data-background="<?php echo base_url()?>assets/img/slider/slider-2.jpg">
                     <div class="container">
                        <div class="row">
                           <div class="col-xxl-7 col-xl-8 col-lg-9 col-md-9 col-sm-10">
                              <div class="slider__content">
                                 <span>Skill Training</span>
                                 <h3 class="slider__title">Skill Training<span class="yellow-bg"><img src="<?php echo base_url()?>assets/img/shape/yellow-bg.png" alt=""> </span></h3>
                                 <p>KGN Computer Academy is a Skill Training Center who provided free Skills program to Student.</p>
                                 <a href="<?php echo base_url()?>Home/about" class="e-btn slider__btn">Ready to get Started?</a>
                              </div>
                           </div>
                        </div>
                 ...
                 <div class="single-slider swiper-slide slider__height slider__overlay d-flex align-items-center" data-background="<?php echo base_url()?>assets/img/slider/slider-3.jpg">
                     <div class="container">
                        <div class="row">
                           <div class="col-xxl-7 col-xl-8 col-lg-9 col-md-9 col-sm-10">
                              <div class="slider__content">
                                 <span>Job Opportunities</span>
                                 <h3 class="slider__title">Job Opportunities<span class="yellow-bg"><img src="<?php echo base_url()?>assets/img/shape/yellow-bg.png" alt=""> </span></h3>
                                 <p>Government Course Opportunity</p>
                                 <a href="<?php echo base_url()?>Home/about" class="e-btn slider__btn">Ready to get Started?</a>
                              </div>
                           </div>
                        </div>
             ...
             <div class="swiper-container slider__nav d-none d-md-block">
               <div class="swiper-wrapper">
                  <div class="slider__nav-item swiper-slide orange-bg" data-background="<?php echo base_url()?>assets/img/slider/nav/slider-nav-4.jpg">
                     <div class="slider__nav-content">
                        <h6>NIELIT Courses</h6>
                        <span>(NIELIT) is an autonomous society that works under the Govt.of India to carry out Human resource</span>
                     </div>
                  </div>
                  <div class="slider__nav-item swiper-slide blue-bg" data-background="<?php echo base_url()?>assets/img/slider/nav/slider-nav-1.jpg">
                     <div class="slider__nav-content">
                        <h6>Vocational Courses</h6>
                        <span>We are running Self Certified Courses for 12 Months (Diploma in Advance Computer Software)</span>
                     </div>
                  </div>
                  <div class="slider__nav-item swiper-slide pink-bg" data-background="<?php echo base_url()?>assets/img/slider/nav/slider-nav-2.jpg">
                     <div class="slider__nav-content">
                     <h6>Skill Training</h6>
                        <span>KGN Computer Academy is a Skill Training Center who provided free Skills program to Student.</span>
                     </div>
                  </div>
                  <div class="slider__nav-item swiper-slide green-bg" data-background="<?php echo base_url()?>assets/img/slider/nav/slider-nav-3.jpg">
                     <div class="slider__nav-content">
                        <h6>Job Opportunities</h6>
                        <span>KGN Computer Academy provided Jobs in All Industries as Computer Operator.</span>
                     </div>
                  </div>
               </div>
             </div>
         ...
         <marquee>Diwali Holidays</marquee>
              <!-- about area start -->
                  ...
                  <div class="col-xxl-6 col-xl-6 col-lg-6">
                     <div class="about__thumb-wrapper">
                        <div class="about__thumb ml-100">
                           <img src="<?php echo base_url()?>assets/image/about.jpg" alt="">
                        </div>
                        <div class="about__banner">
                           <img src="<?php echo base_url()?>assets/image/about1.jpg" alt="">
                        </div>
                  ...
                  <div class="col-xxl-6 col-xl-6 col-lg-6">
                     <div class="about__content">
                        <div class="section__title-wrapper mb-25">
                           <h2 class="section__title"><br><span class="yellow-bg-big">About Us<img src="<?php echo base_url()?>assets/img/shape/yellow-bg-2.png" alt=""></span></h2>
                           <p>KGN COMPUTER ACADEMY is a Computer Education Institution in Jhansi District. We are providing Government and Non Government Computer Courses for All. KGN Computer Academy is an Eduction Division of Modern Welfare Foundation Society.

                                Modern Welfare Foundation is a state level social working Society for Education and other activity. Modern Welfare Foundation is registered under Soceity Registration ACT XXI, 1860 and Also registered on Government NGO Portal NGO Darpan.</p>
                        </div>
                        ...
                        <a href="<?= base_url()?>Home/about" class="btn btn-primary">Read More</a>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="row align-items-end">
                  <div class="col-xxl-5 col-xl-6 col-lg-6">
                     <div class="section__title-wrapper mb-60">
                        <h2 class="section__title"><br><span class="yellow-bg yellow-bg-big">Our Course<img src="<?php echo base_url()?>assets/img/shape/yellow-bg.png" alt=""></span></h2>
 ...
 <!-- teacher area start -->
   ...
   <section class="counter__area pt-145 pb-100">
            <div class="container">
               ...
               <div class="row">
                  <div class="col-xxl-2 offset-xxl-1 col-xl-2 offset-xl-1 col-lg-3 col-md-3 offset-md-0 col-sm-5 offset-sm-2">
                     <div class="counter__item mb-30 center_count">
                  ...
                  <div class="col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-5">
                     <div class="counter__item counter__pl-80 mb-30 center_count">
                  ...
                  <div class="col-xxl-2 offset-xxl-0 col-xl-3 offset-xl-0 col-lg-3 offset-lg-0 col-md-3 offset-md-0 col-sm-5 offset-sm-2">
                     <div class="counter__item counter__pl-34 mb-30 center_count">
                        ...
                        <div class="counter__content">
                           <h4><span class="counter">5,000</span></h4>
                           <p>Student Placed</p>
                        </div>
                     </div>
                  </div>
         ...
         <section class="testimonial__area testimonial__overlay pt-175 pb-170" data-background="<?php echo base_url()?>assets/img/testimonial/testimonial-bg.jpg">
            <div class="container">
                     ...
                     <div class="testimonial__slider-inner swiper-wrapper">
                        ...
                        <div class="testimonial__item text-center swiper-slide">
                           <div class="testimonial__thumb">
                              <img src="<?php echo base_url()?><?=$t->image?>" alt="">
                           </div>
...
<!-- <script scr="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.1/jquery.js"></script>-->
