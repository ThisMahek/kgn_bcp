...
<section class="page__title-area page__title-height page__title-overlay d-flex align-items-center" data-background="<?php echo base_url()?>assets/image/page-title/page-title-2.jpg">
      ...
      <section class="about__area pt-120 pb-150">
         ...
         <!-- brand area start -->
         <section class="counter__area pt-20 pb-100">
            <div class="container">
               <div class="row">
                     ...
                     <div class="testimonial__slider-inner swiper-wrapper">
                        <div class="testimonial__item text-center swiper-slide">
                           <div class="testimonial__thumb">
                               <img src="<?php echo base_url()?>assets/image/testimonial/test1.jpeg" alt="">
                           </div>
                           <div class="testimonial__content">
                              <p>“KGN COMPUTER ACADEMY, KACHERI ROAD OFFICE, JHANSI”</p>
                               <p> We have received tons of encouraging testimonials from our beloved students since our inception in 2010. Anybody can walk into our institute to check.</p>
                        ...
                        <div class="testimonial__item text-center swiper-slide">
                           <div class="testimonial__thumb">
                              <img src="<?php echo base_url()?>assets/image/testimonial/test2.jpeg" alt="">
                           </div>
                           <div class="testimonial__content">
                              <p>“ANSHIKA PROFESSIONAL ACADEMY, BLOCK, CHIRGOAN, DIST. JHANSI,”</p>
                              <p>NOW WE ARE STARING FROM 2ND APRIL 2020 WITH MR. ANIL KUMAR, AN ANOTHER COMPUTER COACHING TO GIVEN DIGITAL KNOWLEDGE TO CHIRGOAN PERSON WHO WANTS TO ED</p>
   
                              <div class="testimonial__info">
                                 <h4>MR. ANIL KUMAR AHIRWAR</h4>
                                 <span>GRADUATE</span>
                              </div>
                           </div>
                        </div>
                        <div class="testimonial__item text-center swiper-slide">
                           ...
                           <div class="testimonial__content">
                              <p>“NOMAN COMPUTER CENTER AND CAFE, MAURANIPUR, JHANSI ”</p>
                                <p>
                                   IN MAURANIPUR BLOCK WE ARE RUNNING AN ANOTHER COMPUTER CENTER TO OFFERING COMPUTER COURSES IN GOVERNMENT SECTOR OR PRIVATE SECTOR. THIS INSTITUTION RU  </p>
                              <div class="testimonial__info">
                                 <h4>RIZWAN KHAN</h4>
                                 <span>MA, O LEVEL</span>
                              </div>
                           </div>
                        </div>
                     </div>
