            ...
            <div class="card-body"> 
                ...
                <form method="post" action="student/dashboard/add_profile" enctype="multipart/form-data">
                    ...
                    <div class="form-group col-md-6">
                        <label>Email</label>
                        <input type="text" class="form-control" placeholder="Enter Name" name="name" value="" disabled >
                    </div>
                    <div class="form-group col-md-6">
                        <label>Number</label>
                        <input type="text" class="form-control" placeholder="Enter Name" name="name" value="" disabled >
                  ...
                  <input type="file" name="pro_img" class="dropify" required />  
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Name" name="fname" value="" required="">
                    </div>
                    <div class="form-group col-md-6">
                        <label>Mother Name</label>
                        <input type="text" class="form-control" placeholder="Enter Name" name="mname" value="" required="">
                    </div>
                    ...
                    <select class="form-control clan" name='class' id="exampleFormControlSelect2" required="">
                          <option value=''>Select Class / Study In</option></option>
...
<script>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" id='rnn'  name="roll_no" value="" required="" style='display:none;'>
                    </div>
                    <div class="form-group col-md-6">
                        <label>Address</label>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control"  name="aadhar_no" value="" required="" >
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        <label>PIN</label>
                        <input type="text" class="form-control"  name="pin_no" value="" required="" >
                    </div>
 ...
 <button type="button" id='' class="btn btn-success btn-sm">Click Here To View</button>
