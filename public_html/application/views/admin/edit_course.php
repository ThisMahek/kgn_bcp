        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <form action="<?=base_url()?>Course/updatecourse" method="post"  enctype="multipart/form-data" >
                        <div class="row">
                        <input type="hiddden" name="id" value="<?=$result->id?>">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                <div class="mb-3">
                                <input class="form-control" type="file" id="formFile" name="course_img" onchange="preview(this)">
                                    <img class="img-thumbnail rounded-circle avatar-xl image" alt="300x200" src="<?php echo base_url()?><?=$result->course_img?>" data-holder-rendered="true">
