...
<form action="<?=base_url()?>Slider/SaveSlider" method="post"  enctype="multipart/form-data" >
                        ...
                        <div class="row">
                            ...
                            <div class="form-group row mb-4">
                                ...
                                <div class="col-sm-12 col-md-7">
                                <div class="mb-3">
                                    <input class="form-control" type="file" id="formFile" name="slider_img" onchange="preview(this)" required>
